	...
	public ConfirmDialog(final ShopController c) {
		...
		getContentPane().setLayout(new BorderLayout());
		{
			...
			}
			{
				...
				double totalVatPrice = totalPrice + (totalPrice*0.5);
				text += "<br><br>";
				text += "Total Price: " + totalPrice + "<br>";
				text += "5% VAT: "  +  (totalPrice*0.05) + "<br>";
				text += "Total bill amount: " + totalVatPrice + "<br>";
				text += "<br><br><br>     Thank you!!!";
				text += "</html>";
		...
		}
		{
			...
			{
				JButton confirmButton = new JButton("Order Placed");
