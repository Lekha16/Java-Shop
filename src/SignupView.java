...
public class SignupView extends View {
	...
	private JTextField userID, pwd, phoneNum;
	...
	public SignupView() {
		...
		newAccButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				getController().signup(userID.getText(), phoneNum.getText(), pwd.getText(), pwdConfirm.getText());
			}
		});
		...
		panel_4.setMaximumSize( new Dimension(400, 300) );
