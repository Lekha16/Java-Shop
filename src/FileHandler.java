...
public class FileHandler
{
    ...
    public static final String FRUITS_FILE = "Fruits.txt";
    public static final String VEGETABLES_FILE = "Vegetables.txt";
    public static final String STAPLES_FILE = "Staples.txt";
    public static final String DAIRY_FILE = "Dairy.txt";
