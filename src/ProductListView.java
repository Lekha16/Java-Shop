...
public class ProductListView extends View {
	...
	public ProductListView() {
		...
		productBox.addItem("Vegetables");
		productBox.addItem("Dairy");
		productBox.addItem("Fruits");
		productBox.addItem("Staples");
		...
		productBox.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				switch (s){
				case "Vegetables":
					initializeByProduct("Vegetables");break;
				case "Dairy":
					initializeByProduct("Dairy");break;
				case "Fruits":
					initializeByProduct("Fruits");break;
				case "Staples":
					initializeByProduct("Staples");break;
				default:
					initialize();break;
				}
			}
		...
		/*
		 * JButton myInfoButton = new JButton("My account"); panel.add(myInfoButton);
		 * 
		 * myInfoButton.addActionListener(new ActionListener(){ public void
		 * actionPerformed(ActionEvent e) { UserDetails.display(getController()); } });
		 */
