...
public class AdminProductListView extends View {
	...
	// ///////////
	// Type content
	public static final ProductType[] TYPE = { ProductType.FRUITS, ProductType.VEGETABLES, ProductType.DAIRY,
		ProductType.STAPLES };
	...
	public AdminProductListView() {
		...
		createProductButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch (productType) {
				case FRUITS:
					AdminProductDetails.displayFruitsDetails(tableModel, getController(),ProductType.FRUITS);
					break;
				case VEGETABLES:
					AdminProductDetails.displayVegetablesDetails(tableModel, getController(),ProductType.VEGETABLES);
					break;
				case DAIRY:
					AdminProductDetails.displayDairyDetails(tableModel, getController(),ProductType.DAIRY);
					break;
				case STAPLES:
					AdminProductDetails.displayStaplesDetails(tableModel, getController(),ProductType.STAPLES);
					break;
					default:break;
				}
		 ...
		 * 
		 * cartButton.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent e) { getController().showAdminReportView(); } });
		 * 
